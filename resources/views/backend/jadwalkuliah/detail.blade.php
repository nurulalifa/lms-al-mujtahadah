                      ...
                      <div class="card-body">
                        {{-- <form method="POST" action="{{url('dosen/update', $dosen->id)}}" enctype="multipart/form-data">
                          ...
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleFormControlInput1" readonly placeholder="Judul Penelitian" value={{$dosen->nama}} name="nama"/>
                          </div>
                          <div class="mb-3">
                            <label for="html5-date-input" class="form-label">Tanggal Kelulusan</label>
                            <div>
                              <input name="tgl"class="form-control" value={{$dosen->tgl}} readonly type="date" id="html5-date-input" />
                            </div>
                          </div>
                          <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" readonly id="exampleFormControlInput1" placeholder="Judul Penelitian" value={{$dosen->univ}} name="univ"/>
                          </div>
                          <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Email</label>
                            <input type="text" class="form-control" readonly id="exampleFormControlInput1" placeholder="Judul Penelitian" value={{$dosen->email}} name="email"/>
                          </div>
                          <div class="mb-3">
                            <label for="exampleFormControlSelect1" class="form-label">Kategori</label>
                            <select readonly name="kategori" class="form-select" id="exampleFormControlSelect1" aria-label="Default select example">
